  ...
  return (
    <div className="flex flex-col items-center">
      <div className="rounded-xl border border-[#3a3a3a] bg-[#1c1c1c] px-4 py-2.5 text-center shadow-lg">
        {label ? (
          <p className="text-[10px] font-medium uppercase tracking-widest text-[#6a6a6a]">
            {label}
          </p>
        ) : null}
...
export default function OverviewPage() {
  ...
  const rankingsQuery = useQuery({
    queryKey: ["technician-rankings", rankingsPage],
    queryFn: () => api.getTechnicianRankings({ page: rankingsPage, limit: 8 }),
  });
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-2">
        ...
        <section className="panel-gradient rounded-[24px] border border-[#343434] p-5">
          ...
          <p className="text-sm text-[#8b8b8b]">
            See your total technicians per year.
          </p>
          <div className="mt-6 h-[340px]">
          ...
          <>
              ...
              <table className="min-w-full">
                ...
                <tbody>
                  {rankingsQuery.data?.rankings.map((ranking, index) => {
                    const rankIndex = (rankingsPage - 1) * 8 + index;
                    return (
                      <tr
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3 text-[#9b9b9b]">
                            <Link
                              ...
                              href={`/dashboard/users/${ranking._id}`}
                            >
            ...
            <div className="mt-5 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <p className="text-[14px] text-[#9b9b9b]">
                ...
                of {rankingsQuery.data?.total ?? 0} results
              </p>
              <Pagination
                page={rankingsPage}
